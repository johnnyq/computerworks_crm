...
$sql = mysqli_query($mysqli,"SELECT * FROM customer_notes, users 
			WHERE customer = $id
			    		...
			    		<div class='row' id='note_$customer_note_id'>
							...
							<div class='col-md-11' id='noteCol2_$customer_note_id'>
					    		<div class='btn-group pull-right'>
									<a class='btn btn-default btn-sm' onclick='editNote($customer_note_id)'><span class='glyphicon glyphicon-edit'></span></a>
									<a class='btn btn-default btn-sm' onclick='deleteNote($customer_note_id)'><span class='glyphicon glyphicon-trash'></span></a>
								</div>	
							...
							<div class='col-md-11 hide' id='noteEditCol2_$customer_note_id'>
	    						...
	    						<div class='btn-group pull-right'>
									<button class='btn btn-default btn-sm' onclick='cancelEdit($customer_note_id)'><span class='glyphicon glyphicon-remove'></span></button>
									<button class='btn btn-default btn-sm' onclick='processEditNote($customer_note_id)'><span class='glyphicon glyphicon-ok'></span></button>
								</div>
								<br>
	    						<hr>
	    					</div>
