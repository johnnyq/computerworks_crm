...
//----------------------------------------------------------------------------
 ...
 var labelType = "";
    ...
    function previewAndPrintstart(labelType,labelTypeID)
    {

           mlabelTypeID = labelTypeID;
           labelType = labelType;
 ...
 // stores loaded label info
    ...
    function previewAndPrint(labelType,labelTypeID)
    {
        ...
        function getPreview()
        {
                  //alert("http://"+thisurl+"dymo/php_print_label_"+labelType+".php?print_id="+mlabelTypeID);
                  if (labelType == "computerLabel"){
                       label = dymo.label.framework.openLabelFile("http://"+thisurl+"/dymo_print_label_design_computer.php?print_id="+mlabelTypeID);
                     }else if(labelType == "customerAddressLabel"){                        
                       label = dymo.label.framework.openLabelFile("http://"+thisurl+"/dymo_print_label_customer_address.php?print_id="+mlabelTypeID);     
                     }else if (labelType == "workOrderLabel"){                        
                       label = dymo.label.framework.openLabelFile("http://"+thisurl+"/dymo_print_label_work_order.php?print_id="+mlabelTypeID);     
                     } 
