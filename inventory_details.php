<?php 
	...
	$sql = mysqli_query($mysqli,"SELECT * from inventory, users, donors WHERE inventory.user_id = users.id AND inventory.donor_id = donors.donor_id AND inventory.inventory_id = $inventory_id");
		...
		<div class="panel panel-default">
			...
			<table class="table">	
			    ...
			    <tbody>
			        ...
			        <?php
						$sql = mysqli_query($mysqli,"SELECT * FROM users, locations, tracking WHERE 
